...
if(isset ($_SESSION['username'])){
  ...
  //Jumlah Koki
  $query_jml_koki = "select count(*) AS jumlah_koki from tb_user natural join tb_level where id_level = 6 and status = 'aktif'";
  $sql_jml_koki = mysqli_query($conn, $query_jml_koki);
  $result_koki = mysqli_fetch_array($sql_jml_koki);
...
<body>
  ...
  ?>
            ...
            <li> <a href="menu.php"><i class="icon icon-tasks"></i> <span>Stok & List Menu Makanan/Minuman</span></a> </li>
            <li> <a href="laporan_transaksi.php"><i class="icon icon-inbox"></i> <span>Laporan Transaksi</span></a> </li>
  ...
  ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li><a href="status_pesanan.php"><i class="icon icon-print"></i> <span>Status Pesanan Pelanggan</span></a> </li>
            <?php
  ...
  ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="pesanan.php"><i class="icon icon-shopping-cart"></i> <span>Pesanan</span></a> </li>
            <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
            <?php
    } else if($r['id_level'] == 6){
      ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="list_pesanan.php"><i class="icon icon-shopping-cart"></i> <span>List Pesanan</span></a> </li>
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="beranda.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Beranda</a></div>
        </div>
        <!--End-breadcrumbs-->
    ...
    ?>
                                    ...
                                    <div class="widget-content nopadding">
                                        <ul class="site-stats quick-actions">
                                            <li class="bg_lb"><i class="icon-user"></i>
                                                <strong><?php echo $result_adm['jumlah_adm']; ?></strong>
                                                <small>Administrator</small></li>
                                            <li class="bg_ly"><i class="icon-user"></i>
                                                <strong><?php echo $result_wtr['jumlah_wtr']; ?></strong> <small>Total
                                                    Waiter</small></li>
                                            <li class="bg_ly" style="background-color: #800080;"><i
                                                    class="icon-user"></i>
                                                <strong><?php echo $result_koki['jumlah_koki']; ?></strong> <small>Total
                                                    Koki</small></li>
                                            <li class="bg_lg"><i class="icon-user"></i>
                                                <strong><?php echo $result_ksr['jumlah_ksr']; ?></strong> <small>Total
                                                    Kasir</small></li>
                                            <li class="bg_ls"><i class="icon-user"></i>
                                                <strong><?php echo $result_own['jumlah_own']; ?></strong> <small>Total
                                                    Owner</small></li>
                                            <li class="bg_lo"><i class="icon-user"></i>
                                                <strong><?php echo $result_plg['jumlah_plg']; ?></strong> <small>Total
                                                    Pelanggan</small></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                ?>
                      ...
                      ?>
                            ...
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_wtr['id_user']; ?>"
                            ...
                            ?>
                                                            <button name="validasi"
                                                                value="<?php echo $r_dt_wtr['id_user']; ?>"
                                                                class="btn btn-info btn-mini"><i
                                                                    class='icon icon-ok'></i></button>
                                                            <button name="hapus_user"
                                                                value="<?php echo $r_dt_wtr['id_user']; ?>"
                      ...
                      ?>
                                ...
                                <div class="widget-box">
                                    <?php
                  $query_data_koki = "select * from tb_user where id_level = 6";
                  $sql_data_koki = mysqli_query($conn, $query_data_koki);
                  $no_koki = 1;
                ?>
                                    ...
                                    <div class="widget-content nopadding">
                                        <table class="table table-bordered table-striped " style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php
                        while($r_dt_koki = mysqli_fetch_array($sql_data_koki)){
                      ?>
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <center><?php echo $no_koki++; ?>.</center>
                                                    </td>
                                                    <td><?php echo $r_dt_koki['nama_user']; ?></td>
                                                    <td><?php echo $r_dt_koki['username']; ?></td>
                                                    <td><?php echo $r_dt_koki['status']; ?></td>
                                                    <td>
                                                        <form action="" method="post">
                                                            <?php 
                              if($r_dt_koki['status'] == 'aktif'){
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_koki['id_user']; ?>"
                                                                class="btn btn-warning btn-mini">
                                                                <i class='icon icon-remove'></i>
                                                            </button>
                                                            <?php 
                ...
                ?>
                      ...
                      ?>
                            ...
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_ksr['id_user']; ?>"
                                                                class="btn btn-warning btn-mini">
                                                                <i class='icon icon-remove'></i>
                                                            </button>
                                                            <?php 
                ...
                ?>
                      ...
                      ?>
                            ...
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_own['id_user']; ?>"
                                                                class="btn btn-warning btn-mini">
                                                                <i class='icon icon-remove'></i>
                                                            </button>
                                                            <?php 
                ...
                ?>
                      ...
                      ?>
                            ...
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_plg['id_user']; ?>"
                                                                class="btn btn-warning btn-mini">
                                                                <i class='icon icon-remove'></i>
                                                            </button>
                                                            <?php 
