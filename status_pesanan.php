...
<body>
  ...
  ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li class="active"> <a href="status_pesanan.php"><i class="icon icon-print"></i> <span>Status Pesanan Pelanggan</span></a> </li>
            <?php
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="list_pesanan.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Pesanan Siap</a></div>
        </div>
        <!--End-breadcrumbs-->
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $nomor = 1;
                  $query_sudah_order = "select * from tb_pesanan";
                  $sql_sudah_order = mysqli_query($conn, $query_sudah_order);
                  while($r_sudah_order = mysqli_fetch_array($sql_sudah_order)){
                ?>
                <tr>
                  <td><center><?php echo $nomor++; ?>. </center></td>
                  <td><center><?php echo $r_sudah_order['no_meja'];?></center></td>
                  <td><center><?php echo $r_sudah_order['status_order'];?></center></td>
                  <td>
                    <form action="" method="post">
                    <center><button type="submit" value="<?php echo $r_sudah_order['id_order'];?>" name="hapus_transaksi" class="btn btn-mini btn-success">
                ...
                <?php
                  ...
                  if(isset($_REQUEST['hapus_transaksi'])){
                    ...
                    $query_hapus_pesanan = "delete from tb_pesanan where id_order = $id_order";
                    $sql_hapus_transaksi = mysqli_query($conn, $query_hapus_pesanan);
