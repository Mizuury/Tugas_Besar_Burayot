...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="pesanan.php">Pesanan</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="pesanan.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Pesanan</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li class="active"> <a href="pesanan.php"><i class="icon icon-shopping-cart"></i> <span>Pesanan</span></a> </li>
            <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
            <?php
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="pesanan.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Pesanan</a></div>
        </div>
        <!--End-breadcrumbs-->
                    ...
                    <div class="widget-box span12">
                        ...
                        <div class="widget-content">
                            <div class="alert alert-info alert-block">
                                ...
                                Silahkan tunggu pesanan tiba di meja saudara. Apabila selesai menyantap hidangan,
                                silahkan lakukan proses pembayaran di kasir !
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right"><strong>Rp.
                                                <?php echo $result_harga['total_harga'];?>,-</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><strong>
      ...
      ?>
            <div class="row-fluid">
                <div class="span8">
                  ...
                  ?>
                                        <li class="span2">
                                            <a> <img src="gambar/<?php echo $r_dt_makanan['gambar_masakan']?>" alt="">
                                            </a>
                                            <div class="actions">
                          ...
                          ?>
                                                <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                    name="tambah_pesan" class="btn btn-danger btn-mini" disabled>
                          ...
                          ?>
                                                <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                    name="tambah_pesan" class="btn btn-success btn-mini">
              ...
              ?>
                                        <tr class="odd gradeX">
                                            <td><span
                                                    id="<?php echo "nama".$r_draft_pesan['id_pesan']; ?>"><?php echo $r_draft_pesan['nama_masakan'];?></span>
                                            </td>
                                            <input id="<?php echo "harga".$r_draft_pesan['id_pesan']; ?>" class="span8"
                                                type="hidden" value="<?php echo $r_draft_pesan['harga'];?>" />
                                            <td>
                                                <center>
                                                    <input id="<?php echo "jumlah".$r_draft_pesan['id_pesan']; ?>"
                                                        class="span8"
                                                        name="jumlah<?php echo $r_draft_pesan['id_masakan']; ?>"
                                                        type="number" value="" placeholder=""
                                            ...
                                            <td>
                                                <form action="" method="post">
                                                    <button type="submit"
                                                        value="<?php echo $r_draft_pesan['id_pesan'];?>"
                                                        name="hapus_pesan" class="btn btn-danger btn-mini">
              ...
              ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <center>
                                                    <input class="span8" name="no_meja" type="number" value=""
                                                        placeholder="" />
                                                </center>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <center>
                                                    <span class="label label-success">&nbsp;Rp. <span
                                                            id="total_harga">0</span>,-&nbsp;</span>
                                                    <input class="span8" id="tot" name="total_harga" type="hidden"
                                                        value="" placeholder="" />
                                                </center>
                                            </td>
                                            <td>
