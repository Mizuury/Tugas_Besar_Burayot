...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="laporan_transaksi.php">Transaksi</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="menu.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri
                Transaksi</span></a>
        <ul>
            ...
            <li class="active"> <a href="laporan_transaksi.php"><i class="icon icon-inbox"></i> <span>Entri
                        Transaksi</span></a> </li>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="laporan_transaksi.php" title="Enttri Transaksi" class="tip-bottom"><i
                        class="icon icon-inbox"></i>
                    Entri Transaksi
                </a>
    ...
    ?>
                ...
                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right"></td>
                                        <td class="right"></td>
                                        <td class="right"><strong>Rp. <span
                                                    id="total_biaya"><?php echo $result_harga['total_harga'];?></span>,-</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                        ...
                        <div class="widget-content nopadding">
                            <form action="#" method="post" class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" id="uang_bayar" name="uang_bayar" class="span11"
                                            placeholder="" onchange="return operasi()" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Kembalian : Rp.</label>
                                    <div class="controls">
                                        <input type="number" id="uang_kembali1" class="span11" placeholder=""
                                            disabled="" />
                                        <input type="hidden" id="uang_kembali" name="uang_kembali" class="span11"
                                            placeholder="" />
                                    </div>
                                </div>
                                <p></p>
                                <center>
                                    <button type="submit" value="<?php echo $result_harga['id_order'];?>"
                                        name="save_order" class="btn btn-success btn-mini">
