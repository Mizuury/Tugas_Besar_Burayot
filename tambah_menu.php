...
<!--Header-part-->
<div id="header">
  <h1><a href="menu.php">Entri Referensi</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar">
  ...
  <ul>
    ...
    <li class="active"> <a href="menu.php"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb">
      <a href="menu.php" title="Entri Referensi" class="tip-bottom">
