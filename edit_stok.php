...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="stok_menu.php">Stok Menu</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <!--sidebar-menu-->
    <div id="sidebar">
        <a href="menu.php" class="visible-phone">
            <i class="icon icon-tasks"></i> <span>Stok Menu</span>
        </a>
        <ul>
            ...
            <li class="active"> <a href="stok_menu.php"><i class="icon icon-shopping-cart"></i> <span>Stok
                        Menu</span></a> </li>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="stok_menu.php" title="Entri Referensi" class="tip-bottom">
      ...
      if(isset($_SESSION['edit_menu'])){
      ?>
                <a href="stok_menu.php" title="Tambah Menu" class="tip-bottom">
                    <i class="icon icon-tasks"></i>
                    Ubah Stok Menu
                </a>
                <?php 
    ...
    ?>
                <div class="widget-box span6">
                  ...
                  if(isset($_SESSION['edit_menu'])){
                ?>
                                    <input name="" type="text" value="<?php echo $nama_masakan; ?>" class="span11"
                                        placeholder="Nama Masakan" disabled="" />
                                    <input name="nama_masakan" type="hidden" value="<?php echo $nama_masakan; ?>"
                                        class="span11" placeholder="Nama Masakan" />
                                    <?php
                  } else {
                ?>
                                    <input name="nama_masakan" type="text" value="" class="span11"
                ...
                ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="stok" value="<?php echo $stok; ?>" type="number" class="span11"
                            ...
                            <div class="control-group">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <input class="span11" value="" name="gambar" type="file" accept="image/*"
                                            onchange="preview(this,'previewne')" disabled="" />
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <img src="gambar/<?php echo $gambar_masakan;?>" id="previewne"
                                            class="rounded border p-1" style="width:110px; height:70px;">
                                    </div>
                                </div>
                            </div>
                ...
                if(isset($_SESSION['edit_menu'])){
              ?>
                                <button type="submit" name="ubah_menu" class="btn btn-info"><i
                                        class='icon icon-save'></i>&nbsp; Simpan Perubahan</button>
                                <?php
                } else {
              ?>
                                <button type="submit" name="tambah_menu" class="btn btn-success"><i
                                        class='icon icon-plus'></i>&nbsp; Tambahkan</button>
                                <?php
                }
              ?>
                                <button type="submit" name="batal_menu" class="btn btn-danger"><i
                                        class='icon icon-remove'></i>&nbsp; Batalkan</a>
                            </div>
                        </form>
                        <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "insert into tb_masakan values ('','$nama_masakan','$stok','$status_masakan','$gambar')";
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $query_ubah_masakan = "update tb_masakan set nama_masakan = '$nama_masakan',stok = '$stok', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";;
