...
<!--Header-part-->
<div id="header">
  <h1><a href="laporan_transaksi.php">Laporan Transaksi</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="menu.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Laporan Transaksi</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
      ?>
      ...
      <li  class="active"> <a href="laporan_transaksi.php"><i class="icon icon-inbox"></i> <span>Laporan Transaksi</span></a> </li>
  ...
  ?>
    <li> <a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li> <a href="pesanan.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
    <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
    <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  <?php
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="laporan_transaksi.php" title="Go to here" class="tip-bottom"><i class="icon icon-inbox"></i>Laporan Transaksi</a></div>
  </div>
<!--End-breadcrumbs-->
...
<?php
  ...
  while($r_sudah_order = mysqli_fetch_array($sql_sudah_order)){
    echo '<tr>
      ...
      <td>'. $r_sudah_order['waktu_pesan'] .'</td>
      <td>'. $r_sudah_order['nama_user'] .'</td>
      <td>'. $r_sudah_order['no_meja'] .'</td>
      <td>Rp. '. $r_sudah_order['total_harga'] .',-</td>
      <td>
        <form action="" method="post">
          <button type="submit" value="'. $r_sudah_order['id_order'] .'" name="hapus_transaksi" class="btn btn-mini btn-danger">
            <i class="icon icon-trash"></i>
            &nbsp; Hapus
          </button>
          <a target="_blank" href="cetak_transaksi.php?konten='. $r_sudah_order['id_order'] .'" class="btn btn-mini btn-success">
            <i class="icon icon-print"></i>
            &nbsp; Cetak
          </a>
        </form>
