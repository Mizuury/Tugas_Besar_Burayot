...
<html lang="en">
<head>
<title>Stok & List Menu Makanan/Minuman</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="menu.php">Stok & List Menu Makanan/Minuman</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="menu.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Stok & List Menu Makanan/Minuman</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
      ?>
      <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
      <li class="active"> <a href="menu.php"><i class="icon icon-tasks"></i> <span>Stok & List Menu Makanan/Minuman</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="menu.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i>Stok & List Menu Makanan/Minuman</a></div>
  </div>
<!--End-breadcrumbs-->
